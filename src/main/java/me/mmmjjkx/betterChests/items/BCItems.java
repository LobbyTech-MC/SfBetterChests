...
public class BCItems {
    ...
    public static final ChestDisassembler CHEST_DISASSEMBLER = new ChestDisassembler(
            ...
            new ItemStack[]{
                    ...
                    new ItemStack(Material.IRON_INGOT), new ItemStack(Material.SHORT_GRASS), new ItemStack(Material.IRON_INGOT),
    ...
    public static final ChestColorer CHEST_COLORER = new ChestColorer(
            ...
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.SHORT_GRASS), null,
    ...
    public static final SimpleChest CHEST_27 = new SimpleChest(
            27,
            new SlimefunItemStack("BC_CHEST_27", Material.SHORT_GRASS, "&b&lSimple Chest"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, null, null,
    ...
    public static final OnlyInputChest CHEST_INPUT_27 = new OnlyInputChest(
            27,
            new SlimefunItemStack("BC_CHEST_INPUT_27", Material.SHORT_GRASS, "&b&lSimple Chest &c&l(Input Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
    ...
    public static final OnlyOutputChest CHEST_OUTPUT_27 = new OnlyOutputChest(
            27,
            new SlimefunItemStack("BC_CHEST_OUTPUT_27", Material.SHORT_GRASS, "&b&lSimple Chest &c&l(Output Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.REDSTONE), null,
                    null, CHEST_27.getItem().clone(), null,
    ...
    public static final SimpleChest CHEST_36 = new SimpleChest(
            36,
            new SlimefunItemStack("BC_CHEST_36", Material.SHORT_GRASS, "&b&lBig Chest"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, null, null,
    ...
    public static final OnlyInputChest CHEST_INPUT_36 = new OnlyInputChest(
            36,
            new SlimefunItemStack("BC_CHEST_INPUT_36", Material.SHORT_GRASS, "&b&lBig Chest &c&l(Input Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.HOPPER), null,
    ...
    public static final OnlyOutputChest CHEST_OUTPUT_36 = new OnlyOutputChest(
            36,
            new SlimefunItemStack("BC_CHEST_OUTPUT_36", Material.SHORT_GRASS, "&b&lBig Chest &c&l(Output Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.REDSTONE), null,
                    null, CHEST_36.getItem().clone(), null,
    ...
    public static final SimpleChest CHEST_45 = new SimpleChest(
            45,
            new SlimefunItemStack("BC_CHEST_45", Material.SHORT_GRASS, "&b&lBigger Chest"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, null, null,
    ...
    public static final OnlyInputChest CHEST_INPUT_45 = new OnlyInputChest(
            45,
            new SlimefunItemStack("BC_CHEST_INPUT_45", Material.SHORT_GRASS, "&b&lBigger Chest &c&l(Input Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.HOPPER), null,
    ...
    public static final OnlyOutputChest CHEST_OUTPUT_45 = new OnlyOutputChest(
            45,
            new SlimefunItemStack("BC_CHEST_OUTPUT_45", Material.SHORT_GRASS, "&b&lBigger Chest &c&l(Output Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.REDSTONE), null,
                    null, CHEST_45.getItem().clone(), null,
    ...
    public static final SimpleChest CHEST_54 = new SimpleChest(
            54,
            new SlimefunItemStack("BC_CHEST_54", Material.SHORT_GRASS, "&b&lThe Biggest Chest"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, null, null,
    ...
    public static final OnlyInputChest CHEST_INPUT_54 = new OnlyInputChest(
            54,
            new SlimefunItemStack("BC_CHEST_INPUT_54", Material.SHORT_GRASS, "&b&lThe Biggest Chest &c&l(Input Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.HOPPER), null,
    ...
    public static final OnlyOutputChest CHEST_OUTPUT_54 = new OnlyOutputChest(
            54,
            new SlimefunItemStack("BC_CHEST_OUTPUT_54", Material.SHORT_GRASS, "&b&lThe Biggest Chest &c&l(Output Only)"),
            RecipeType.ENHANCED_CRAFTING_TABLE,
            new ItemStack[]{
                    null, new ItemStack(Material.REDSTONE), null,
                    null, CHEST_54.getItem().clone(), null,
